 ...
 */
$PhSoft_vers = 'PhSoft 1 (C) 2000-2014';
...
define('PH_USE_MYSQLI', TRUE && extension_loaded("mysqli"), TRUE);
$PH_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "dbname", "qs" => "`", "qe" => "`");
$PH_CONN[0] = &$PH_CONN["DB"];
...
class mysqlt_driver_ADOConnection extends ADOConnection {
  ...
  function __construct() {
    $this->dbtype = (PH_USE_MYSQLI) ? 'mysqli' : 'mysqlt';
