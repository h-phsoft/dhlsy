...
<input type="text" data-table="cpy_slider_trn" data-field="x_slid_link" name="x<?php echo $cpy_slider_trn_grid->RowIndex ?>_slid_link" id="x<?php echo $cpy_slider_trn_grid->RowIndex ?>_slid_link" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($cpy_slider_trn->slid_link->getPlaceHolder()) ?>" value="<?php echo $cpy_slider_trn->slid_link->EditValue ?>"<?php echo $cpy_slider_trn->slid_link->EditAttributes() ?>>
</span>
