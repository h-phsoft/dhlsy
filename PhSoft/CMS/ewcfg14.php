...
define("EW_PROJECT_NAME", "DHL_SY_2018", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{EB80027D-BFC8-4F25-85BB-6B03A26BA4A8}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'BchnFxh8RArnN6ey', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/DHL_SY_2018.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "dhlsy", "qs" => "`", "qe" => "`");
...
define("EW_ADMIN_PASSWORD", "OndGod165", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`phs_users`", TRUE);
define("EW_USER_NAME_FILTER", "(`user_logon` = '%u')", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "../../assets/img/blkImages/", TRUE); // Upload destination path (relative to app root)
