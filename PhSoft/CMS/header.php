...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>PhSoft_ICO.ico"><link rel="icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>PhSoft_ICO.ico">
