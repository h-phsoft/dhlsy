...
class ccpy_news_images extends cTable {
	...
	function __construct() {
		...
		// nimg_order
		$this->nimg_order = new cField('cpy_news_images', 'cpy_news_images', 'x_nimg_order', 'nimg_order', '`nimg_order`', '`nimg_order`', 2, -1, FALSE, '`nimg_order`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`news_id` ASC,`nimg_order` ASC";
	}
