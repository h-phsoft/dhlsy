...
fphs_usersdelete.Lists["x_pgrp_id"] = {"LinkField":"x_pgrp_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pgrp_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"phs_pgroup"};
fphs_usersdelete.Lists["x_pgrp_id"].Data = "<?php echo $phs_users_delete->pgrp_id->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php if ($phs_users->user_id->Visible) { // user_id ?>
		<th class="<?php echo $phs_users->user_id->HeaderCellClass() ?>"><span id="elh_phs_users_user_id" class="phs_users_user_id"><?php echo $phs_users->user_id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($phs_users->user_id->Visible) { // user_id ?>
		<td<?php echo $phs_users->user_id->CellAttributes() ?>>
<span id="el<?php echo $phs_users_delete->RowCnt ?>_phs_users_user_id" class="phs_users_user_id">
