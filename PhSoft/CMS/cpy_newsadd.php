...
class ccpy_news_add extends ccpy_news {
	...
	function AddRow($rsold = NULL) {
		...
		// news_text
		$this->news_text->SetDbValueDef($rsnew, $this->news_text->CurrentValue, "", FALSE);
		if ($this->news_image->Visible && !$this->news_image->Upload->KeepFile) {
			$this->news_image->UploadPath = '../../assets/img/newsImages/';
...
fcpy_newsadd.Lists["x_news_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcpy_newsadd.Lists["x_news_status"].Options = <?php echo json_encode($cpy_news_add->news_status->Options()) ?>;
fcpy_newsadd.Lists["x_type_id"] = {"LinkField":"x_type_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_type_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_news_type"};
fcpy_newsadd.Lists["x_type_id"].Data = "<?php echo $cpy_news_add->type_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($cpy_news->news_status->Visible) { // news_status ?>
	<div id="r_news_status" class="form-group">
		<label id="elh_cpy_news_news_status" for="x_news_status" class="<?php echo $cpy_news_add->LeftColumnClass ?>"><?php echo $cpy_news->news_status->FldCaption() ?></label>
		<div class="<?php echo $cpy_news_add->RightColumnClass ?>"><div<?php echo $cpy_news->news_status->CellAttributes() ?>>
...
<?php if ($cpy_news->type_id->Visible) { // type_id ?>
	<div id="r_type_id" class="form-group">
		<label id="elh_cpy_news_type_id" for="x_type_id" class="<?php echo $cpy_news_add->LeftColumnClass ?>"><?php echo $cpy_news->type_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_news_add->RightColumnClass ?>"><div<?php echo $cpy_news->type_id->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fcpy_newsadd", "x_news_date", {"ignoreReadonly":true,"useCurrent":false,"format":5});
</script>
<?php } ?>
</span>
...
<?php if ($cpy_news->news_text->Visible) { // news_text ?>
	<div id="r_news_text" class="form-group">
		<label id="elh_cpy_news_news_text" class="<?php echo $cpy_news_add->LeftColumnClass ?>"><?php echo $cpy_news->news_text->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
ew_CreateEditor("fcpy_newsadd", "x_news_text", 35, 4, <?php echo ($cpy_news->news_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
