...
<?php if ($phs_users->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_phs_users_user_id" class="<?php echo $phs_users_edit->LeftColumnClass ?>"><?php echo $phs_users->user_id->FldCaption() ?></label>
		<div class="<?php echo $phs_users_edit->RightColumnClass ?>"><div<?php echo $phs_users->user_id->CellAttributes() ?>>
...
<?php echo $phs_users->user_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
