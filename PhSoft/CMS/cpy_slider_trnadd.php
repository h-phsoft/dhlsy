...
$cpy_slider_trn_add = NULL; // Initialize page object first

class ccpy_slider_trn_add extends ccpy_slider_trn {
	...
	// Page object name
	var $PageObjName = 'cpy_slider_trn_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("cpy_slider_trnlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cpy_slider_trnview.php")
	...
	function LoadDefaultValues() {
		...
		$this->slid_photo->CurrentValue = NULL; // Clear file related field
	...
	function RenderRow() {
		...
		$this->slid_text->ViewCustomAttributes = "";
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->slid_photo);
...
// Create page object
if (!isset($cpy_slider_trn_add)) $cpy_slider_trn_add = new ccpy_slider_trn_add();

// Page init
$cpy_slider_trn_add->Page_Init();

// Page main
$cpy_slider_trn_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cpy_slider_trn_add->Page_Render();
?>
...
var CurrentForm = fcpy_slider_trnadd = new ew_Form("fcpy_slider_trnadd", "add");

// Validate form
fcpy_slider_trnadd.Validate = function() {
...
fcpy_slider_trnadd.Form_CustomValidate = 
...
fcpy_slider_trnadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcpy_slider_trnadd.Lists["x_slid_id"] = {"LinkField":"x_slid_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_slid_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"cpy_slider_mst"};
fcpy_slider_trnadd.Lists["x_slid_id"].Data = "<?php echo $cpy_slider_trn_add->slid_id->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $cpy_slider_trn_add->ShowPageHeader(); ?>
<?php
$cpy_slider_trn_add->ShowMessage();
?>
<form name="fcpy_slider_trnadd" id="fcpy_slider_trnadd" class="<?php echo $cpy_slider_trn_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cpy_slider_trn_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cpy_slider_trn_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cpy_slider_trn">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cpy_slider_trn_add->IsModal) ?>">
...
<?php if ($cpy_slider_trn->slid_id->Visible) { // slid_id ?>
	<div id="r_slid_id" class="form-group">
		<label id="elh_cpy_slider_trn_slid_id" for="x_slid_id" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_id->CellAttributes() ?>>
...
<?php if ($cpy_slider_trn->slid_order->Visible) { // slid_order ?>
	<div id="r_slid_order" class="form-group">
		<label id="elh_cpy_slider_trn_slid_order" for="x_slid_order" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_order->FldCaption() ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_order->CellAttributes() ?>>
...
<?php if ($cpy_slider_trn->slid_header->Visible) { // slid_header ?>
	<div id="r_slid_header" class="form-group">
		<label id="elh_cpy_slider_trn_slid_header" for="x_slid_header" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_header->FldCaption() ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_header->CellAttributes() ?>>
...
<?php if ($cpy_slider_trn->slid_link->Visible) { // slid_link ?>
	<div id="r_slid_link" class="form-group">
		<label id="elh_cpy_slider_trn_slid_link" for="x_slid_link" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_link->FldCaption() ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_link->CellAttributes() ?>>
...
<?php if ($cpy_slider_trn->slid_photo->Visible) { // slid_photo ?>
	<div id="r_slid_photo" class="form-group">
		<label id="elh_cpy_slider_trn_slid_photo" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_photo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_photo->CellAttributes() ?>>
...
<?php if ($cpy_slider_trn->slid_text->Visible) { // slid_text ?>
	<div id="r_slid_text" class="form-group">
		<label id="elh_cpy_slider_trn_slid_text" class="<?php echo $cpy_slider_trn_add->LeftColumnClass ?>"><?php echo $cpy_slider_trn->slid_text->FldCaption() ?></label>
		<div class="<?php echo $cpy_slider_trn_add->RightColumnClass ?>"><div<?php echo $cpy_slider_trn->slid_text->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fcpy_slider_trnadd", "x_slid_text", 35, 4, <?php echo ($cpy_slider_trn->slid_text->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if (!$cpy_slider_trn_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cpy_slider_trn_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cpy_slider_trn_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcpy_slider_trnadd.Init();
</script>
<?php
$cpy_slider_trn_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cpy_slider_trn_add->Page_Terminate();
?>
