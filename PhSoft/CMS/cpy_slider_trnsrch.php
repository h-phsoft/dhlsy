...
<input type="text" data-table="cpy_slider_trn" data-field="x_slid_photo" name="x_slid_photo" id="x_slid_photo" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($cpy_slider_trn->slid_photo->getPlaceHolder()) ?>" value="<?php echo $cpy_slider_trn->slid_photo->EditValue ?>"<?php echo $cpy_slider_trn->slid_photo->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
