...
class ccpy_slider_mst extends cTable {
	...
	function __construct() {
		...
		// slid_rem
		$this->slid_rem = new cField('cpy_slider_mst', 'cpy_slider_mst', 'x_slid_rem', 'slid_rem', '`slid_rem`', '`slid_rem`', 201, -1, FALSE, '`slid_rem`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
