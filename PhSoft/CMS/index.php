...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'cpy_block'))
			$this->Page_Terminate("cpy_blocklist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_block_detail'))
			$this->Page_Terminate("cpy_block_detaillist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_menu'))
			$this->Page_Terminate("cpy_menulist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'cpy_page_block'))
			$this->Page_Terminate("cpy_page_blocklist.php");
		...
		if ($Security->AllowList(CurrentProjectID() . 'cpy_menu_mode'))
			$this->Page_Terminate("cpy_menu_modelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_menu_type'))
			$this->Page_Terminate("cpy_menu_typelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_menu_search'))
			$this->Page_Terminate("cpy_menu_searchlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'cpy_news_type'))
			$this->Page_Terminate("cpy_news_typelist.php");
